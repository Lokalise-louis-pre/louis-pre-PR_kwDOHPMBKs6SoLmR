export type DescendantOptions<T = Record<string, unknown>> = T & {
    /**
 ...
 */
export declare class DescendantsManager<T extends HTMLElement, K extends Record<string, any> = Record<string, unknown>> {
    private descendants;
